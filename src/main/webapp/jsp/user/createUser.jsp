							...
							<form name="createAccountForm" action="#" method="post" onsubmit="event.preventDefault(); validateAccountCreation();">
								...
								<div class="uk-margin">
									<div class="uk-inline uk-width-1-1">
										...
										<input class="uk-input uk-form-large" id="name" type="text" name="userName" placeholder="Name*">
									</div>
								</div>
								<div class="uk-margin">
									<div class="uk-inline uk-width-1-1">
								...
								<div class="uk-margin">
									<div class="uk-inline uk-width-1-1">
										...
										<input class="uk-input uk-form-large" id="password" type="password" name="password" placeholder="Password*">
									</div>
								</div>
								<div class="uk-margin">
									<div class="uk-inline uk-width-1-1">
