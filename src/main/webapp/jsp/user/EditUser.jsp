						...
						<form name="editAccountForm" action="#" method="post"
							...
							<div class="uk-margin">
								<div class="uk-inline uk-width-1-1">
									...
									<input class="uk-input uk-form-large" id="oldPassword" type="password" name="oldPassword" placeholder="Old Password">
								</div>
							</div>
							<div class="uk-margin">
								<div class="uk-inline uk-width-1-1">
									<span class="uk-form-icon" uk-icon="icon: lock"></span>
									<input class="uk-input uk-form-large" id="newPassword" type="password" name="newPassword" placeholder="New Password">
								</div>
							</div>
							<div class="uk-margin">
								<div class="uk-inline uk-width-1-1">
