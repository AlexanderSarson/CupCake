...
@Ignore
public class createUserValidationTest extends TestBase {
    ...
    public createUserValidationTest (DesiredCapabilities capabilities) {
        super(capabilities);
    }
    ...
    public void Should_GoToFrontController_When_LoginSuccessful () {
        ...
        String expectedUrl = "http://localhost:8080/CupCake/FrontController";
